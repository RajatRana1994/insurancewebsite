<div class="nav-toggler-wrapper d-inline-block d-lg-none">
    <a class="nav-toggler">
        <span></span>
        <span></span>
    </a>
...
<div class="header-left d-flex">
    <div class="logo">
        <a class="header-brand" href="<?php echo $node_base_url; ?>"><img src="/public/front_end/assets/img/logo.png" alt="Logo" /></a>
    </div>
    <ul class="header-nav p-0 d-none d-xl-flex">
        <li class="header-nav-item">
            <a class="header-nav-link" href="#"><span>Learn, Compare, Save <i class="fa fa-angle-down drop-arrow" aria-hidden="true"></i></span></a>
            <div class="mega-menu">
                <div class="mega-menu-inner">
                    <ul class="mega-menu-list">
                        <h3 class="mega_menu_heading">Products</h3>
                        <h4 class="mega_menu_subheading">Insurance For you and your family</h4>
                        <li class="is-submenu-item is-dropdown-submenu-item">
                            <a href="<?php echo $node_base_url; ?>get_auto_nsurance">Auto insurance </a>
                        </li>
                        <li class="is-dropdown-submenu-parent " >
                            <a href="<?php echo $node_base_url; ?>get_home_nsurance">Home insurance </a>
                        </li>
                        <li class="is-dropdown-submenu-parent active">
                            <a href="<?php echo $node_base_url; ?>get_life_nsurance">Life insurance </a>
                        </li>
                        <li class="is-dropdown-submenu-parent">
                            <a href="<?php echo $node_base_url; ?>get_renter_nsurance">Renters insurance </a>
                        </li>
                        <li class="is-dropdown-submenu-parent">
                            <a href="<?php echo $node_base_url; ?>get_travel_nsurance">Travel insurance</a>
                        </li>
                    </ul>
                    <ul class="mega-menu-list">
                        <h3 class="mega_menu_heading"></h3>
                        <h4 class="mega_menu_subheading">Insurance for your Business</h4>
                        <li class="is-dropdown-submenu-parent">
                            <a href="<?php echo $node_base_url; ?>get_business_nsurance">Business insurance </a>
                        </li>
                        <li class="is-dropdown-submenu-parent" >
                            <a href="<?php echo $node_base_url; ?>get_worker_comp_nsurance">Workers Comp</a>
                        </li>
                        <!--li class="is-dropdown-submenu-parent" >
                            <a href="">Commerical Auto</a>
                        </li>
                        <li class="is-dropdown-submenu-parent" >
                            <a href="">Professional Liability </a>
                        </li>
                        <li class="is-dropdown-submenu-parent" >
                            <a href="">Contractor Liability </a>
                        </li>
                        <li class="is-dropdown-submenu-parent" >
                            <a href="">coverage for specific industry </a>
                        </li-->
                    </ul>
                    <ul class="mega-menu-list">
                        <h3 class="mega_menu_heading">Resources</h3>
                        <li class="is-dropdown-submenu-parent">
                            <a href="<?php echo $node_base_url; ?>resource/1">1. Protect what matters: your business</a>
                        </li>
                        <li class="is-dropdown-submenu-parent" >
                            <a href="<?php echo $node_base_url; ?>resource/2">2. Wait! Doesn’t my LLC already protect me?</a>
                        </li>
                        <li class="is-dropdown-submenu-parent" >
                            <a href="<?php echo $node_base_url; ?>resource/3">3. Professional Liability insurance? But I do good work!</a>
                        </li>
                        <li class="is-dropdown-submenu-parent" >
                            <a href="<?php echo $node_base_url; ?>resource/4">4. When should I shop for a BOP?</a>
                        </li>
                        <li class="is-dropdown-submenu-parent" >
                            <a href="<?php echo $node_base_url; ?>resource/5">5. Workers Comp</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="header-right">
    <nav class="navigation">
        <ul class="header-nav p-0 d-flex d-xl-none">
            <li class="header-nav-item">
                <a class="header-nav-link" href="#"><span>Learn, Compare, Save <i class="fa fa-angle-down drop-arrow" aria-hidden="true"></i></span></a>
                <div class="mega-menu-inner">
                    <ul class="mega-menu-list">
        ...
        <ul class="header-nav">
            <li class="header-nav-item">
                <a class="header-nav-link" href="#"><span>Company <i class="fa fa-angle-down drop-arrow" aria-hidden="true"></i></span></a>
                <div class="mega-menu">
                    <div class="mega-menu-inner">
                        <ul class="mega-menu-list">
                            <h3 class="mega_menu_heading">Products</h3>
                            <li class="is-submenu-item is-dropdown-submenu-item">
                                <a href="<?php echo $node_base_url; ?>about-defy">About Us</a>
                            </li>
                            <li class="is-dropdown-submenu-parent " >
                                <a href="<?php echo $node_base_url; ?>about-defy">Why Defy?</a>
                            </li>
                            <li class="is-dropdown-submenu-parent active">
                                <a href="">Team</a>
                            </li>
                            ...
                            <li class="is-dropdown-submenu-parent">
                                <a href="<?php echo $node_base_url; ?>carrier-info">Our Carriers</a>
                            </li>
                            <li class="is-dropdown-submenu-parent">
                                <a href="<?php echo $node_base_url; ?>contact">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <li class="header-nav-item">
                <a class="header-nav-link" href="#"><span>Client Services <i class="fa fa-angle-down drop-arrow" aria-hidden="true"></i></span></a>
                <div class="mega-menu">
                    <div class="mega-menu-inner">
                        <ul class="mega-menu-list">
                            <h3 class="mega_menu_heading">Products</h3>
                            ...
                            <li class="is-dropdown-submenu-parent active">
                                <a href="">Policy Review Request</a>
                            </li>
                            <li class="is-dropdown-submenu-parent">
                                <a href="">Calculators</a>
                            </li>
                            <li class="is-dropdown-submenu-parent">
                                <a href="<?php echo $node_base_url; ?>referal">Refer a Friend</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <li class="header-nav-item">
                <a class="header-nav-link" href="<?php echo $node_base_url; ?>blogs"><span>Blog</span></a>
            </li>
            <li class="header-nav-item">
                <a class="header-nav-link" href="#"><span>Partnership <i class="fa fa-angle-down drop-arrow" aria-hidden="true"></i></span></a>
                <div class="mega-menu">
                    <div class="mega-menu-inner">
                        <ul class="mega-menu-list">
                            <h3 class="mega_menu_heading">Products</h3>
                            ...
                            <li class="is-dropdown-submenu-parent " >
                                <a href="">Companies we represent</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="call-us">
        <a class="call-us-link" href="#">
            <svg x="0px" y="0px" viewBox="0 0 511.999 511.999" width="15" height="15" style="enable-background:new 0 0 511.999 511.999;">
            <g>
            <path
